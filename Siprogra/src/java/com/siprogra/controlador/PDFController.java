...
import com.siprogra.DAO.ContenidoFacade;
import com.siprogra.DAO.ParametroFacade;
import com.siprogra.DAO.ProcesodegradoFacade;
import com.siprogra.DAO.ProductodetrabajoFacade;
import com.siprogra.DAO.UsuarioFacade;
import com.siprogra.clases.ActaAprobacionAnteproyecto;
import com.siprogra.modelo.Contenido;
import com.siprogra.modelo.Parametro;
import com.siprogra.modelo.Procesodegrado;
import com.siprogra.modelo.Productodetrabajo;
import com.siprogra.modelo.Usuario;
import java.io.File;
...
public class PDFController implements Serializable 
{
    ...
    {
        lstProcesogrado = ejbProcesogrado.buscarPorEstado("EVALUACION DEL ANTEPROYECTO");
    }
    public void generarPDFActaSecretaria() //throws com.lowagie.text.DocumentException 
    {
        try 
        {
            File file = File.createTempFile(actaAnteproyecto.getNumeroActa()+"ActaSecretaria", ".pdf");
            //String pdfFileName = file.getName();
            Document document = new Document();
            PdfWriter pdfwriter = PdfWriter.getInstance(document, new FileOutputStream(file));
            document.open();
            Font bold = new Font(Font.FontFamily.HELVETICA, 12f, Font.BOLD | Font.UNDERLINE);
            Paragraph tituloPoL = new Paragraph("Acta de la Secretaria jejeje", bold);
            ...
            document.add((Element) new Chunk("Número de acta: "+actaAnteproyecto.getNumeroActa()));
            document.add((Element) new Chunk(" Fecha del acta: "+actaAnteproyecto.getFechaActa()));
            document.close();
        } 
        ...
        System.out.println("termino de hacer el pdf");
    }
...
//
    ...
    public ProcesodegradoFacade getEjbProcesogrado() 
    {
        return ejbProcesogrado;
    }
    ...
    {
        return ejbProcesogrado.buscarPorEstado("EVALUACION DEL ANTEPROYECTO");
    }
